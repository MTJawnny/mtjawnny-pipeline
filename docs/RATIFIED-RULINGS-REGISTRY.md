...
Generated by `python3 tests/guards/gate2/foundry_ruling_registry.py`. Re-run after any
...
```
python3 tests/guards/gate2/foundry_ruling_registry.py --check <NAME>.md
```
