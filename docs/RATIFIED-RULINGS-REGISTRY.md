...
| `CODEBOOK-NAMING-GRAMMAR.md` | 536 | 18 | 1 | **NO** |
...
| `DEFINITION-DRIFT-AUDIT-2026-08-02.md` | 286 | 2 | 0 | yes |
...
| `TIER-3-DECISION-PACKET-2026-08-02.md` | 600 | 6 | 1 | **NO** |
...
`DAMAGE-DELIVERY-RULING-2026-08-02.md`, `DERIVED-TAG-LAYER-SPEC.md`, `FAMILY-TREE-EVIDENCE.md`, `MEMBERSHIP-RATIFICATION-PACKET-2026-08-02.md`, `REAUDIT-TIER-1-FINDINGS-2026-08-02.md`, `REAUDIT-TIER-3-3-2026-08-02.md`, `REMINDER-TEXT-QUALIFICATION-CASCADE-ISSUE.md`, `TIER-2-DECISION-PACKET-2026-08-02.md`
...
- `F3` (line 227) — the type matters), `opponent-tapped-creature-count` (F3, walk-ratification
...
**`TIER-3-DECISION-PACKET-2026-08-02.md`** — sole home for 1:

- `D13` (line 61) — > **Not executed, and not in scope of this ratification:** D13 (by-power
...
### `ADD-01` — 7 reference(s) across 3 doc(s)
...
### `CDR-01` — 9 reference(s) across 5 doc(s)
...
### `CDR-09` — 20 reference(s) across 11 doc(s)
...
- `CODEBOOK-NAMING-GRAMMAR.md:270` — 8a. CDR-09 amendment — sense is carried by POSITION and BINDING, not by grammatical number (Captain-ratified 2026-08-02)
- `CODEBOOK-NAMING-GRAMMAR.md:402` — by the CDR-09 walk below.**
- `CODEBOOK-NAMING-GRAMMAR.md:404` — 12a. CDR-09 counter-homograph walk (Captain-ratified 2026-08-02) — **EXECUTED 2026-08-02**
- `CODEBOOK-NAMING-GRAMMAR.md:412` — > `docs/CDR-09-WALK-DERIVATION-2026-08-02.md`.
...
### `D1` — 20 reference(s) across 8 doc(s)
...
- `CODEBOOK-NAMING-GRAMMAR.md:491` — D-1:** `death-trigger-` stays the family word (no `dies-` slugs).
...
### `D13` — 3 reference(s) across 1 doc(s)
...
- `CODEBOOK-NAMING-GRAMMAR.md:492` — D-2:** bare verb stems; `counters-` verb form retained (section 8).
...
### `D3` — 11 reference(s) across 5 doc(s)

- `CODEBOOK-NAMING-GRAMMAR.md:215` — One connective, one order, closed stat list — RATIFIED (D-3):
- `CODEBOOK-NAMING-GRAMMAR.md:232` — `lifegain-scales-with-sacrificed-creature-toughness` was ratified as a D-3
- `CODEBOOK-NAMING-GRAMMAR.md:243` — `docs/TIER-3-DECISION-PACKET-2026-08-02.md` D3/D4.
- `CODEBOOK-NAMING-GRAMMAR.md:493` — D-3:** `-scales-with-` is the sole scaling connective; `-scaled-by-`
...
### `D4` — 15 reference(s) across 7 doc(s)
...
- `CODEBOOK-NAMING-GRAMMAR.md:236` — parameterized stat** (tier-3 D4, Captain-ratified 2026-08-02). Both were
- `CODEBOOK-NAMING-GRAMMAR.md:243` — `docs/TIER-3-DECISION-PACKET-2026-08-02.md` D3/D4.
- `CODEBOOK-NAMING-GRAMMAR.md:495` — D-4:** the §3 activation-restriction enumeration is DET-owned; SYNTH is
...
- `CODEBOOK-NAMING-GRAMMAR.md:3` — Status: RATIFIED by Captain, 2026-07-30 (decisions D-1 through D-5 resolved per
- `CODEBOOK-NAMING-GRAMMAR.md:497` — D-5:** banned-token list (§10.2) and per-slug idiomatic-leaf exemption
...
### `D7` — 7 reference(s) across 5 doc(s)
...
- `CODEBOOK-NAMING-GRAMMAR.md:227` — the type matters), `opponent-tapped-creature-count` (F3, walk-ratification
...
- `CODEBOOK-NAMING-GRAMMAR.md:505` — F3, Q5, F4, Q6, Q8.5); see that document for the full ruling text.
- `CODEBOOK-NAMING-GRAMMAR.md:522` — F4 soft-warning tier:** `and` is ratified vocabulary (closed-vocab check
...
### `Q2` — 13 reference(s) across 10 doc(s)

- `CODEBOOK-NAMING-GRAMMAR.md:504` — Applied per `docs/WALK-RATIFICATION-EXECUTION-HANDOFF.md` section 2 (Q2, Q3,
...
- `CODEBOOK-NAMING-GRAMMAR.md:483` — Q6 (walk-ratification 2026-07-31):** 7 further idiomatic-leaf exemptions
- `CODEBOOK-NAMING-GRAMMAR.md:505` — F3, Q5, F4, Q6, Q8.5); see that document for the full ruling text.
