...
- documents scanned: **53 documents under docs/**
...
| `CODEBOOK-NAMING-GRAMMAR.md` | 581 | 18 | 1 | **NO** |
...
| `DEFINITION-DRIFT-AUDIT-2026-08-02.md` | 260 | 2 | 0 | yes |
...
| `PARENT-TREE-CANDIDATES.md` | 400 | 17 | 8 | **NO** |
...
- `F3` (line 272) — the type matters), `opponent-tapped-creature-count` (F3, walk-ratification
...
- `CODEBOOK-NAMING-GRAMMAR.md:476` — the axis count by one. Third arithmetic drift caught in rev 2; see ADD-06.
...
- `CODEBOOK-NAMING-GRAMMAR.md:351` — Consequence for the canonicalizer (ADD-08), measured 2026-08-02.**
- `CODEBOOK-NAMING-GRAMMAR.md:370` — the names, and both must be fixed before ADD-08 is implemented:
- `CODEBOOK-NAMING-GRAMMAR.md:384` — be zero. ADD-08 stays blocked on §12a either way.
...
- `CDR-PROPOSALS.md:480` — ADD-05 — AG-EQUIV-01 scope must include A15-instantiated axes** (CDR-05).
- `CODEBOOK-NAMING-GRAMMAR.md:488` — CDR-05.
...
- `CODEBOOK-NAMING-GRAMMAR.md:315` — 8a. CDR-09 amendment — sense is carried by POSITION and BINDING, not by grammatical number (Captain-ratified 2026-08-02)
- `CODEBOOK-NAMING-GRAMMAR.md:447` — by the CDR-09 walk below.**
- `CODEBOOK-NAMING-GRAMMAR.md:449` — 12a. CDR-09 counter-homograph walk (Captain-ratified 2026-08-02) — **EXECUTED 2026-08-02**
- `CODEBOOK-NAMING-GRAMMAR.md:457` — > `docs/CDR-09-WALK-DERIVATION-2026-08-02.md`.
...
- `CODEBOOK-NAMING-GRAMMAR.md:536` — D-1:** `death-trigger-` stays the family word (no `dies-` slugs).
...
- `CODEBOOK-NAMING-GRAMMAR.md:537` — D-2:** bare verb stems; `counters-` verb form retained (section 8).
...
- `CODEBOOK-NAMING-GRAMMAR.md:260` — One connective, one order, closed stat list — RATIFIED (D-3):
- `CODEBOOK-NAMING-GRAMMAR.md:277` — `lifegain-scales-with-sacrificed-creature-toughness` was ratified as a D-3
- `CODEBOOK-NAMING-GRAMMAR.md:288` — `docs/TIER-3-DECISION-PACKET-2026-08-02.md` D3/D4.
- `CODEBOOK-NAMING-GRAMMAR.md:538` — D-3:** `-scales-with-` is the sole scaling connective; `-scaled-by-`
...
- `CODEBOOK-NAMING-GRAMMAR.md:281` — parameterized stat** (tier-3 D4, Captain-ratified 2026-08-02). Both were
- `CODEBOOK-NAMING-GRAMMAR.md:288` — `docs/TIER-3-DECISION-PACKET-2026-08-02.md` D3/D4.
- `CODEBOOK-NAMING-GRAMMAR.md:540` — D-4:** the §3 activation-restriction enumeration is DET-owned; SYNTH is
...
- `CODEBOOK-NAMING-GRAMMAR.md:3` — Status: RATIFIED by Captain, 2026-07-30 (decisions D-1 through D-5 resolved per
- `CODEBOOK-NAMING-GRAMMAR.md:542` — D-5:** banned-token list (§10.2) and per-slug idiomatic-leaf exemption
...
- `CODEBOOK-NAMING-GRAMMAR.md:272` — the type matters), `opponent-tapped-creature-count` (F3, walk-ratification
- `CODEBOOK-NAMING-GRAMMAR.md:550` — F3, Q5, F4, Q6, Q8.5); see that document for the full ruling text.

### `F4` — 3 reference(s) across 2 doc(s)

- `CODEBOOK-NAMING-GRAMMAR.md:550` — F3, Q5, F4, Q6, Q8.5); see that document for the full ruling text.
- `CODEBOOK-NAMING-GRAMMAR.md:567` — F4 soft-warning tier:** `and` is ratified vocabulary (closed-vocab check
...
- `CODEBOOK-NAMING-GRAMMAR.md:549` — Applied per `docs/WALK-RATIFICATION-EXECUTION-HANDOFF.md` section 2 (Q2, Q3,
...
- `CODEBOOK-NAMING-GRAMMAR.md:528` — Q6 (walk-ratification 2026-07-31):** 7 further idiomatic-leaf exemptions
- `CODEBOOK-NAMING-GRAMMAR.md:550` — F3, Q5, F4, Q6, Q8.5); see that document for the full ruling text.
...
- `CODEBOOK-NAMING-GRAMMAR.md:571` — Q8.5 `cant-be-blocked` compound stem token** ratified into vocabulary
- `SESSION-HANDOFF-2026-08-02-EVE.md:94` — Tier-3 D13** — `evasion-vs-high/low-power-blockers` vs Q8's ratified
- `TIER-4-DECISION-PACKET-2026-08-02.md:395` — `rule:evasion-vs-low-power-blockers`** — all four "can't be blocked by creatures with power 2 or less" ✓. Its **name** is the open tier-3 D13 question (Q8's ratified `cant-be-blocked-<restriction>` grammar); **not re-ra…
